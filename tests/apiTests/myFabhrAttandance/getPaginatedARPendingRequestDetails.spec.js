...
test.describe("Get Paginated AR Pending Request Details API", () => {
  ...
  test("Get Paginated AR Pending Request Details - Success scenario  @happy", async ({ request }) => {
  ...
  test("Get Paginated AR Pending Request Details - Verify AR entry appears after successful application  @happy", async ({ request }) => {
  ...
  test("Get Paginated AR Pending Request Details - Invalid pagination parameters  @negative", async ({ request }) => {
  ...
  test("Get Paginated AR Pending Request Details - Without authentication token  @negative", async ({ request }) => {
    const response = await attendance.getPaginatedARPendingRequestDetails(
      request,
      getPaginatedARPendingRequestDetailsExpected.baseRequestBody, null,
      employeeId,
      flag
    ); // No token passed
  ...
  test("Get Paginated AR Pending Request Details - Different page sizes  @happy", async ({ request }) => {
    const testCases = [
  ...
  test("Get Paginated AR Pending Request Details - All sorting scenarios  @happy", async ({ request }) => {
  ...
  test("Get Paginated AR Pending Request Details - Sort by all fields with ASC and DESC  @happy", async ({ request }) => {

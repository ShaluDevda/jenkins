...
test.describe("GET| /hrmsApi/holidays/findAllHoliday/{leavePeriodId}, get findAllHoliydays", () => {
  let authToken, response, companyId, leavePeriodId;
  ...
  test("Get findAllHolidays - Happy flow @happy", async ({ request }) => {

    response = await leave.findAllHolidays(request, authToken, leavePeriodId);
